                ...
                <div class="col-md-4 col-sm-4">
                    <article class="blog-list">
                        <div class="blog-info-box">
                            ...
                            <a href="#"><img src="{{asset('assets/images/recent-blog-1.jpg')}}" class="img-responsive" alt="image"></a>
                            <ul>
                ...
                <div class="col-md-4 col-sm-4">
                    <article class="blog-list">
                        <div class="blog-info-box">
                            ...
                            <a href="#"><img src="{{asset('assets/images/recent-blog-2.jpg')}}" class="img-responsive" alt="image"></a>
                            <ul>
                                <li><a href="#"><i class="fa fa-tags" aria-hidden="true"></i>Latest Cars</a></li>
                ...
                <div class="col-md-4 col-sm-4">
                    <article class="blog-list">
                        <div class="blog-info-box">
                            ...
                            <a href="#"><img src="{{asset('assets/images/recent-blog-3.jpg')}}" class="img-responsive" alt="image"></a>
                            <ul>
                                <li><a href="#"><i class="fa fa-tags" aria-hidden="true"></i>Latest Cars</a></li>
