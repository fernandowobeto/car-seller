...
<nav class="navbar navbar-transparent navbar-absolute">
    <div class="container">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="../dashboard/overview.html">Admin Car Seller</a>
        </div>
    </div>
</nav>

<div class="wrapper wrapper-full-page">
    <div class="full-page login-page" data-color="" data-image="{{asset('assets/admin/img/background/background-2.jpg')}}">
                                ...
                                <div class="card-content">
                                    <div class="form-group">
                                        ...
                                        <input type="email"
                                               ...
                                               name="username"
                                               value="fernandowobeto@gmail.com"
        ...
        <footer class="footer footer-transparent">
            <div class="container">
                <div class="copyright">
                    &copy; <script>document.write(new Date().getFullYear())</script>, <a href="https://www.fernandowobeto.com">Fernando Wobeto</a>
                </div>
            </div>
        </footer>
    </div>
...
<script src="{{asset('assets/admin/js/es6-promise-auto.min.js')}}"></script>
...
<script src="{{asset('assets/admin/js/bootstrap-switch-tags.js')}}"></script>
...
<!-- Vector Map plugin -->
<script src="{{asset('assets/admin/js/jquery-jvectormap.js')}}"></script>
...
<script src="{{asset('assets/admin/js/bootstrap-table.js')}}"></script>
